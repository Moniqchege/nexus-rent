...
router.post(
    ...
    audit({
        ...
        title: 'Created Service Provider',
        subtitle: (req) => req.body.name,
        metadata: (req) => ({
...
router.patch(
    ...
    requireAuth,
    audit({
        action: 'update_service_provider',
        title: 'Service Provider',
        subtitle: (req) => `Updated Provider #${req.params.id}`,
        metadata: (req) => ({
...
router.delete(
    ...
    audit({
        ...
        title: 'Service Provider',
        subtitle: (req) => `Deleted Provider #${req.params.id}`,
    }),
    async (req: Request, res: Response) => {
        try {
            const rawId = req.params.id;
