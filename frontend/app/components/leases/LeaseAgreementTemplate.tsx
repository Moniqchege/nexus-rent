...
const normalizeBillingCycle = (cycle?: string) => {
  ...
  return (
    <div>
      <div style={{ display: "flex", gap: "12px", marginBottom: "14px", justifyContent: "flex-end" }}>
        <button
          onClick={handlePrint}
          style={{
      ...
      >
        <h1 style={{ textAlign: "center", fontSize: "18px", color: "var(--neon-blue)" }}>
